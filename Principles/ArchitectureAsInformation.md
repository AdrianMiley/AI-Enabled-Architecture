...
"Architecture as Data" treats the structure and design of a system (whether physical, digital, or organizational) as a dynamic dataset rather than just a static blueprint. 

This approach allows architects to use computational tools to modify, analyze, and automate management of the architectural artefacts.
