...
| Mermaid        | For machine readable diagrams                           |
| ANTLR          | For defining structured english grammars                |
| YAML or JSON   |                                                         |
| GitHub         | For version control                                     |
| GitHub Copilot |                                                         |
| Groovy         | For scripts that modify a source file                   |
| Velocity       | For scripts that generate a new file from a source file |

##  Scripting languages

All scripts should be written in either Groovy (.groovy) or Velocity (.vm)
AI generated scripts should be clearly marked as such in the comments withthe following header...

    /*
    This script was generated by GitHub Copilot and should be used as a starting point for further development and refinement. 
    It may require additional work to ensure it meets the specific requirements of the project and should be tested and debugged to ensure it works as intended.
    */

... and should be tested to ensure they work as intended.

Do not create scripts in any other language (e.g. Powershell scripts) without first discussing it with the project maintainers.
...
The "children" section of the YAML header must be updated as new pages are added to the section.

###  Adding New Markdown Documents
...
This allows for easy navigation through the documentation.
    ...
    [Section Contents](index.md) [Home](../index.md)  
