---
title: Code Lists
description: Domain and enumerated values management
---
...
In almost every database application ever designed and built there has been a requirement to hold and maintain Attribute Value Constraints (also known as Domain Values, Enumerated Values, Reference Codes etc.) that define the valid values that are allowed for a particular Attribute.
