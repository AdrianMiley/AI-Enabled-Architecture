...
2.	Expressing or bringing into prominence the individuality of the artist or author.
      ...
      For example, I don’t need to know how a DVD Player works in order to utilise it – just that it can be built. In order to build the DVD Player I don’t need to know how to manufacture an LED in order to include one as a component in my DVD Player.
